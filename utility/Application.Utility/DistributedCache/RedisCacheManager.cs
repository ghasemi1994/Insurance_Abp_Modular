...
public class RedisCacheManager : DistributedCacheManager
{
    ...
    public RedisCacheManager(IOptions<DistributedCacheSettings> settings, IDistributedCache distributedCache) : base(settings, distributedCache)
    {
        _connectionWrapper ??= new RedisConnectionWrapper(settings?.Value?.ConnectionString);
