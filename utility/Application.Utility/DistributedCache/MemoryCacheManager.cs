...
public partial class MemoryCacheManager : CacheKeyService, ILocker, IStaticCacheManagerService
{
    #region Fields
    ...
    public MemoryCacheManager(IOptions<DistributedCacheSettings> settings, IMemoryCache memoryCache) : base(settings)
    {
