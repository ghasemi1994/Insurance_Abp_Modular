...
using static Application.Utility.DistributedCache.CacheKey;

namespace Application.Utility.DistributedCache;

public abstract class DistributedCacheManager : CacheKeyService, IStaticCacheManagerService, ILocker
{
    #region Fields
    ...
    protected DistributedCacheManager(
        IOptions<DistributedCacheSettings> settings,
        IDistributedCache distributedCache ) : base(settings)
    {
